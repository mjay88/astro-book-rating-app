...
And that concludes this tutorial on Vue js! You can find the completed code in github [here](https://github.com/mjay88/vue-book-rating-app 'Completed App in github').
